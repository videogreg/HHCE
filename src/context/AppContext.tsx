...
const createDemoData = (): AppState => {
  ...
  const visits: Visit[] = [
    { id: uuidv4(), clientId: cl1.id, clientName: cl1.name, clientAddress: cl1.address, clientZone: cl1.zone, date: formatLocalDate(today), startTime: '09:30', durationMinutes: 120, assignedTeamId: t1.id, assignedCleanerIds: t1.cleanerIds, cancelled: false, teamName: t1.name, dismissedViolations: [] },
    { id: uuidv4(), clientId: cl2.id, clientName: cl2.name, clientAddress: cl2.address, clientZone: cl2.zone, date: formatLocalDate(today), startTime: '10:00', durationMinutes: 90, assignedTeamId: t2.id, assignedCleanerIds: t2.cleanerIds, cancelled: false, teamName: t2.name, dismissedViolations: [] },
    { id: uuidv4(), clientId: cl4.id, clientName: cl4.name, clientAddress: cl4.address, clientZone: cl4.zone, date: formatLocalDate(today), startTime: '09:00', durationMinutes: 75, assignedTeamId: t3.id, assignedCleanerIds: t3.cleanerIds, cancelled: false, teamName: t3.name, dismissedViolations: [] },
    { id: uuidv4(), clientId: cl6.id, clientName: cl6.name, clientAddress: cl6.address, clientZone: cl6.zone, date: formatLocalDate(addDays(today, 1)), startTime: '09:00', durationMinutes: 60, assignedTeamId: t1.id, assignedCleanerIds: t1.cleanerIds, cancelled: false, teamName: t1.name, dismissedViolations: [] },
    { id: uuidv4(), clientId: cl3.id, clientName: cl3.name, clientAddress: cl3.address, clientZone: cl3.zone, date: formatLocalDate(addDays(today, 2)), startTime: '10:00', durationMinutes: 150, assignedTeamId: t2.id, assignedCleanerIds: t2.cleanerIds, cancelled: false, teamName: t2.name, dismissedViolations: [] },
    { id: uuidv4(), clientId: cl5.id, clientName: cl5.name, clientAddress: cl5.address, clientZone: cl5.zone, date: formatLocalDate(addDays(today, 2)), startTime: '08:00', durationMinutes: 180, assignedTeamId: t3.id, assignedCleanerIds: t3.cleanerIds, cancelled: false, teamName: t3.name, dismissedViolations: [] },
    { id: uuidv4(), clientId: cl7.id, clientName: cl7.name, clientAddress: cl7.address, clientZone: cl7.zone, date: formatLocalDate(addDays(today, 4)), startTime: '11:00', durationMinutes: 120, assignedTeamId: t1.id, assignedCleanerIds: t1.cleanerIds, cancelled: false, teamName: t1.name, dismissedViolations: [] },
